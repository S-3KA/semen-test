<button onclick="formclose()" id="call-btn">заказать звонок</button>
<div class="pos">
<form name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" id="call-form" class="form-hiden"  method="post" enctype="multipart/form-data">
<?
...
<?endif?>
    ...
    <div id="call-close" onclick="formclose()"></div>
    <p class="call_text"><?=GetMessage('GET_CALL')?></p>
	<?=bitrix_sessid_post()?>
...
//            $key = '6LeVl1YdAAAAAO1TxkQcO0SlyQsxIBbOkp3YbvZ6';
